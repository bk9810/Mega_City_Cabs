...
/**
 * Servlet implementation class ManageLocationsController
 */
@WebServlet("/reg/manageLocations")
public class ManageLocationsController extends HttpServlet {
...
private LocationService locationService;
     ...
     */
    public ManageLocationsController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
		  try {
	            ...
	            request.getRequestDispatcher("/reg/manageLocations.jsp").forward(request, response);
