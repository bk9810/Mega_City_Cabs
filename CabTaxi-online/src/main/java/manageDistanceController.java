...
/**
 * Servlet implementation class manageDistanceController
 */
@WebServlet("/admin/managedistan")
public class manageDistanceController extends HttpServlet {
     ...
     */
    public manageDistanceController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            request.getRequestDispatcher("/admin/ManageDistances.jsp").forward(request, response);
