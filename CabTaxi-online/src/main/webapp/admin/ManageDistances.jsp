...
<body>
  ...
  <div class="card mt-4">
    ...
    <div class="card-body">
      ...
      <form method="post" action="managedistan" style="display: ${not empty locations && locations.size() >= 2 ? 'block' : 'none'}">
        <div class="row">
        ...
        <div>
        <div class="mt-3">
            <a href="location" class="btn btn-secondary">Manage Locations</a>
